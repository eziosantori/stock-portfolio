...
// functions/stocks/getCashFlow.ts
var getCashFlow = async (event, context, callback) => {
...
var getCashFlow_default = getCashFlow;

// functions/cash-flow.ts
var handler = async (event, context, callback) => {
  if (event.httpMethod === "GET") {
    return await getCashFlow_default(event, context, callback);
  } else {
    return {
      statusCode: 405,
